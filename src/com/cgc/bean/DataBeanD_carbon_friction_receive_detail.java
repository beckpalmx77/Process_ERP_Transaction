 ...
 * @author Beckeck
 */
public class DataBeanD_carbon_friction_receive_detail {
    ...
    /**
     * @param weight_in the weight_in to set
     */
    ...
    /**
     * @param weight_balance the weight_balance to set
     */
