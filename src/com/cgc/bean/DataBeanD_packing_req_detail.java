 ...
 * @author Beckeck
 */
public class DataBeanD_packing_req_detail {
     ...
     * @return the qty_use
     */
    public String getQty_use() {
        return qty_use;
    }

    /**
     * @param qty_use the qty_use to set
     */
    public void setQty_use(String qty_use) {
